 ...
 * @Version: 1.0
 */
public class MyWaterMarkViewActivity extends Activity implements RadioGroup.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_selef_define_mark_view);
        ...
        waterMaskView.getBackground().setAlpha(12);
