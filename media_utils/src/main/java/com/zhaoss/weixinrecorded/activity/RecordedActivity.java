...
public class RecordedActivity extends BaseActivity {
    public static final int REQUEST_CODE_VIDEO = 0x112;
    ...
    private void shotPhoto(final byte[] nv21) {
        ...
        RxJavaUtil.run(new RxJavaUtil.OnRxAndroidListener<String>() {
            ...
            public String doInBackground() throws Throwable {
                ...
                String photoPath = LanSongFileUtil.getDefaultDir() + System.currentTimeMillis() + ".jpeg";
    ...
    public void finishVideo() {
        RxJavaUtil.run(new RxJavaUtil.OnRxAndroidListener<String>() {
            ...
            public String doInBackground() throws Exception {
                //合并h264
                String h264Path = LanSongFileUtil.getDefaultDir() + System.currentTimeMillis() + ".h264";
                Utils.mergeFile(segmentList.toArray(new String[]{}), h264Path);
                //h264转mp4
                String mp4Path = LanSongFileUtil.getDefaultDir() + System.currentTimeMillis() + ".mp4";
    ...
    private String syntPcm() throws Exception {
        ...
        String pcmPath = LanSongFileUtil.getDefaultDir() + System.currentTimeMillis() + ".pcm";
        ...
        try {
            ...
            for (int x = 0; x < aacList.size(); x++) {
                ...
                try {
                    in = new FileInputStream(aacList.get(x));
                    ...
                    Log.e("RecordedActivity", e.getMessage());
                } finally {
                    try {
                        if (null != in) {
                            in.close();
    ...
    private void startRecord() {
        ...
        RxJavaUtil.run(new RxJavaUtil.OnRxAndroidListener<Boolean>() {
            ...
            public Boolean doInBackground() throws Throwable {
                videoPath = LanSongFileUtil.getDefaultDir() + System.currentTimeMillis() + ".h264";
                audioPath = LanSongFileUtil.getDefaultDir() + System.currentTimeMillis() + ".pcm";
