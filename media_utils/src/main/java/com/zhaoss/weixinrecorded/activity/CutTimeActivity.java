...
public class CutTimeActivity extends BaseActivity{
    ...
    private void initMediaPlay(SurfaceTexture surface){
        ...
        try {
            ...
            Log.e("CutSizeActivity",e.getMessage());
        }
    ...
    private void initVideoSize(){
        ...
        //最小剪切时间1秒
        int pxWidth = (int) (1f/mMediaInfo.getvDuration()*thumbnailView.getWidth());
    ...
    private void changeTime(){
        ...
        startTime = (int) (mMediaInfo.getvDuration()*1000*pro1);

        float right = thumbnailView.getRightInterval();
        float pro2 = right/ll_thumbnail.getWidth();
        endTime = (int) (mMediaInfo.getvDuration()*1000*pro2);
    }
    ...
    private void initThumbs(){
        ...
        int frameCount = 10;
        final float interval = frameCount/mMediaInfo.getvDuration();//提取帧的间隔
