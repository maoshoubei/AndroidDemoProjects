...
public class RecordedButton extends View {
        ...
        if (buttonAnim == null || !buttonAnim.isRunning()) {
            ...
            buttonAnim.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    ...
                    float dp5Division2 = dp5 / 2f;

                    value = 1 - zoom - value;
                    oval.left = measuredWidth * value / 2 + dp5Division2;
                    oval.top = measuredWidth * value / 2 + dp5Division2;
                    oval.right = measuredWidth * (1 - value / 2) - dp5Division2;
                    oval.bottom = measuredWidth * (1 - value / 2) - dp5Division2;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (measuredWidth == -1) {
            ...
            float dp5Division2 = dp5 / 2;

            oval.left = dp5Division2;
            oval.top = dp5Division2;
            oval.right = measuredWidth - dp5Division2;
            oval.bottom = measuredWidth - dp5Division2;
        }
    }
