...
public class VideoLayout extends VideoEditor {
     ...
     * 是否使用软件解码器
     */
    private static final boolean isUseSoftDecoder=true;
    /**
     * 两个视频合并;
     * <p>
     * 原理是(一下所有多个视频类似):
    ...
    public String executeLayoutScale2Video(int outW, int outH,
        ...
        String filter = String.format(Locale.getDefault(), "nullsrc=size=%dx%d [base];"+
                ...
                outW, outH,p1.getScaleW(), p1.getScaleH(), p2.getScaleW(), p2.getScaleH(), p1.getX(), p1.getY(),p2.getX(), p2.getY());


        float duration = getMaxDuration(Arrays.asList(p1.getVideo(), p2.getVideo()));
        ...
        cmdList.add("-i");
        cmdList.add(p1.getVideo());

        cmdList.add("-i");
        cmdList.add(p2.getVideo());
    ...
    public String executeLayoutScale3Video(int outW, int outH,
        ...
        String filter = String.format(Locale.getDefault(),
                ...
                outW, outH,p1.getScaleW(), p1.getScaleH(), p2.getScaleW(), p2.getScaleH(),p3.getScaleW(), p3.getScaleH(), p1.getX(), p1.getY(),p2.getX(), p2.getY(),p3.getX(), p3.getY());



        List<String> cmdList = new ArrayList<String>();

        float duration = getMaxDuration(Arrays.asList(p1.getVideo(), p2.getVideo(), p3.getVideo()));
        filter+=getAudioCmd();
        if(!isUseSoftDecoder){
            cmdList.add("-vcodec");
            cmdList.add("lansoh264_dec");
                                           ...
                                           VideoLayoutParam p4)
    {
        ...
        String filter = String.format(Locale.getDefault(),
                ...
                outW, outH,p1.getScaleW(),
                p1.getScaleH(), p2.getScaleW(), p2.getScaleH(),p3.getScaleW(), p3.getScaleH(), p4.getScaleW(), p4.getScaleH(),
                p1.getX(), p1.getY(),p2.getX(), p2.getY(),p3.getX(), p3.getY(),p4.getX(), p4.getY());

        List<String> cmdList = new ArrayList<String>();

        float dstDuration=getMaxDuration(Arrays.asList(p1.getVideo(),p2.getVideo(),p3.getVideo(),p4.getVideo()));
        filter+=getAudioCmd();
        if(!isUseSoftDecoder){
            cmdList.add("-vcodec");
            cmdList.add("lansoh264_dec");
    ...
    public String executeLayoutScale5Video(int outW, int outH,
        ...
        String filter = String.format(Locale.getDefault(),
                ...
                outW, outH,p1.getScaleW(),
                p1.getScaleH(), p2.getScaleW(), p2.getScaleH(),p3.getScaleW(), p3.getScaleH(), p4.getScaleW(), p4.getScaleH(), p5.getScaleW(), p5.getScaleH(),
                p1.getX(), p1.getY(),p2.getX(), p2.getY(),p3.getX(), p3.getY(),p4.getX(), p4.getY(),p5.getX(), p5.getY());

        List<String> cmdList = new ArrayList<String>();

        float dstDuration=getMaxDuration(Arrays.asList(p1.getVideo(),p2.getVideo(),p3.getVideo(),p4.getVideo(),p5.getVideo()));
        filter+=getAudioCmd();
    ...
    public String executeLayoutScale6Video(int outW, int outH,
        ...
        String filter = String.format(Locale.getDefault(),
                ...
                outW, outH,p1.getScaleW(),
                p1.getScaleH(), p2.getScaleW(), p2.getScaleH(),p3.getScaleW(), p3.getScaleH(), p4.getScaleW(), p4.getScaleH(), p5.getScaleW(), p5.getScaleH(),p6.getScaleW(), p6.getScaleH(),
                p1.getX(), p1.getY(),p2.getX(), p2.getY(),p3.getX(), p3.getY(),p4.getX(), p4.getY(),p5.getX(), p5.getY(),p6.getX(), p6.getY());
        List<String> cmdList = new ArrayList<String>();

        float dstDuration=getMaxDuration(Arrays.asList(p1.getVideo(),p2.getVideo(),p3.getVideo(), p4.getVideo(),p5.getVideo(),p6.getVideo()));
        filter+=getAudioCmd();
    ...
    public String executeLayoutScale9Video(int outW, int outH,
        ...
        String filter = String.format(Locale.getDefault(), "[0:v] setpts=PTS-STARTPTS,scale=%dx%d,pad=%d:%d:%d:%d:White [in1]; [1:v] setpts=PTS-STARTPTS,scale=%dx%d [in2];[2:v] setpts=PTS-STARTPTS,scale=%dx%d [in3];[3:v] setpts=PTS-STARTPTS,scale=%dx%d [in4]; [4:v] setpts=PTS-STARTPTS,scale=%dx%d [in5]; [5:v] setpts=PTS-STARTPTS,scale=%dx%d [in6]; [6:v] setpts=PTS-STARTPTS,scale=%dx%d [in7];[7:v] setpts=PTS-STARTPTS,scale=%dx%d [in8]; [8:v] setpts=PTS-STARTPTS,scale=%dx%d [in9]; [in1][in2] overlay=x=%d:y=%d [tmp1]; [tmp1][in3] overlay=x=%d:y=%d [tmp2]; [tmp2][in4] overlay=x=%d:y=%d [tmp3];[tmp3][in5] overlay=x=%d:y=%d [tmp4]; [tmp4][in6] overlay=x=%d:y=%d [tmp5]; [tmp5][in7] overlay=x=%d:y=%d [tmp6]; [tmp6][in8] overlay=x=%d:y=%d [tmp7]; [tmp7][in9] overlay=x=%d:y=%d",
                p1.getScaleW(),p1.getScaleH(),outW, outH,p1.getX(),p1.getY(),p2.getScaleW(),p2.getScaleH(),p3.getScaleW(),p3.getScaleH(),p4.getScaleW(),p4.getScaleH(),p5.getScaleW(),p5.getScaleH(),p6.getScaleW(),p6.getScaleH(),p7.getScaleW(),p7.getScaleH(),p8.getScaleW(),p8.getScaleH(),p9.getScaleW(),p9.getScaleH(),p2.getX(),p2.getY(),p3.getX(),p3.getY(),p4.getX(),p4.getY(),p5.getX(),p5.getY(),p6.getX(),p6.getY(),p7.getX(),p7.getY(),p8.getX(),p8.getY(),p9.getX(),p9.getY());

        float duration=getMaxDuration(Arrays.asList(p1.getVideo(),p2.getVideo(),p3.getVideo(),p4.getVideo(),p5.getVideo(),p6.getVideo(),p7.getVideo(),p8.getVideo(),p9.getVideo()));
        filter+=getAudioCmd();
        List<String> cmdList = new ArrayList<String>();
        ...
        cmdList.add("-i");
        cmdList.add(p7.getVideo());

        cmdList.add("-i");
        cmdList.add(p8.getVideo());

        cmdList.add("-i");
        cmdList.add(p9.getVideo());
    ...
    private float getMaxDuration(List<String> array) {
        ...
        for (String str : array) {
            ...
            if (info.prepare() ){
                if(info.isHaveVideo()) {
                    if (info.getvDuration() > retDuration) {
                        retDuration = info.getvDuration();
                    }
                }
                if(info.isHaveAudio()){
                    audioTrackCnt++;
