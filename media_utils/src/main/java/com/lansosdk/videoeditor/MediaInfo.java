...
public class MediaInfo {
	...
	private final String fileName; // 视频的文件名, 路径的最后一个/后的字符串.
	private final String fileSuffix; // 文件的后缀名.
	/**
	...
	public void setvCodecHeight(int vCodecHeight) {
		this.vCodecHeight = vCodecHeight;
	}
	...
	public void setvCodecWidth(int vCodecWidth) {
		this.vCodecWidth = vCodecWidth;
	}
	...
	public void setvTotalFrames(int vTotalFrames) {
		this.vTotalFrames = vTotalFrames;
	}
	...
	public void setvDuration(float vDuration) {
	...
	public void setvFrameRate(float vFrameRate) {
	...
	public void setvRotateAngle(float vRotateAngle) {
		this.vRotateAngle = vRotateAngle;
	}
	...
	public void setvHasBFrame(boolean vHasBFrame) {
		this.vHasBFrame = vHasBFrame;
	}
	...
	public void setvCodecName(String vCodecName) {
		this.vCodecName = vCodecName;
	}
	...
	public void setvPixelFmt(String vPixelFmt) {
		this.vPixelFmt = vPixelFmt;
	}
	...
	public void setaTotalFrames(int aTotalFrames) {
		this.aTotalFrames = aTotalFrames;
	}
	...
	public void setaMaxBitRate(int aMaxBitRate) {
		this.aMaxBitRate = aMaxBitRate;
	}
	...
	public void setaDuration(float aDuration) {
	...
	public void setaCodecName(String aCodecName) {
		this.aCodecName = aCodecName;
	}
	...
	public void setGetSuccess(boolean getSuccess) {
