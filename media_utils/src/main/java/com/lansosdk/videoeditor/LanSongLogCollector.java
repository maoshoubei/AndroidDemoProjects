...
public class LanSongLogCollector implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            Log.i("LanSongLogCollector", e.getMessage());
            notifyReady();
        }
    }
    ...
    private void waitUntilReady() {
        synchronized (mLock) {
            ...
            try {
                ...
                Log.e("LanSongLogCollector", ie.getMessage());
            }
        }
    }
    ...
    private void notifyReady() {
        synchronized (mLock) {
            mReady = true;
            mLock.notifyAll(); // signal waitUntilReady()
        }
    }
    ...
    private String readFile() {
        ...
        try {
            ...
            try {
                ...
                Log.e("LanSongLogCollector", e.getMessage());
            }
        }
    }
    ...
    class StreamConsumer extends Thread {
        ...
        public void run() {
            try {
                ...
                Log.i("LanSongLogCollector", ioe.getMessage());
